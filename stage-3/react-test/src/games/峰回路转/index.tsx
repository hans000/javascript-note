            ...
            <div className='peak-turn--bar'>
                {
                    ans.length
                        ? (
                            <Button className='btn' type='primary' onClick={redo}>重做</Button>
                        )
                        : (
                            <Button className='btn' type='primary' onClick={share}>分享</Button>
                        )
                }
